...
-- ESTA EXPLICACIÓN NO LA HE ENCONTRADO EN NINGÚN VIDEO...
...
select "Name" as "Track_Name", "Milliseconds" as "Duration_Minutes"
from "Track"
where "Milliseconds" > 300000;
...
from "Track" 
where "Milliseconds" > 250000 and "MediaTypeId" = 1 or "MediaTypeId" = 2;
